...
store?.readFromFile('./amelia_store.json')
// save every 10s
setInterval(() => {
	store?.writeToFile('./amelia_store.json')
}, 10_000)
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = '❖━━━━━━[ ʟᴇᴀᴠɪɴɢ ]━━━━━━❖\n𝚂𝚊𝚢𝚘𝚗𝚊𝚛𝚊𝚊 @user 👋😃'
  conn.spromote = '@user ꜱᴇᴋᴀʀᴀɴɢ ᴛᴇʟᴀʜ ᴍᴇɴᴊᴀᴅɪ ᴀᴅᴍɪɴ!\n\nｎｏｔｅ: ᴊᴀɴɢᴀɴ ꜱᴇᴇɴᴀᴋɴʏᴀ ʏᴀ ᴋʟᴏ ᴊᴀᴅɪ ᴀᴅᴍɪɴ'
  conn.sdemote = '@user ꜱᴇᴋᴀʀᴀɴɢ ʙᴜᴋᴀɴ ᴀᴅᴍɪɴ ʟᴀɢɪ!\n\nｎｏｔｅ: ꜰᴏʟʟᴏᴡ ɪɴꜱᴛʀᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/l4c1f2r'
  conn.sDesc = 'ᴅᴇꜱᴋʀɪᴘꜱɪ ᴛᴇʟᴀʜ ᴅɪᴜʙᴀʜ ᴍᴇɴᴊᴀᴅɪ \n@desc'
  conn.sSubject = 'ᴊᴜᴅᴜʟ ɢʀᴜᴘ ᴛᴇʟᴀʜ ᴅɪᴜʙᴀʜ ᴍᴇɴᴊᴀᴅɪ \n@subject'
  conn.sIcon = 'Icon grup telah diubah!'
  conn.sRevoke = 'ʟɪɴᴋ ɢʀᴏᴜᴘ ᴛᴇʟᴀʜ ᴅɪ ʀᴇꜱᴇᴛ ᴋᴇ \n@revoke'
  conn.sAnnounceOn = 'ɢʀᴏᴜᴘ ᴛᴇʟᴀʜ ᴅɪ ᴛᴜᴛᴜᴘ!\nꜱᴇᴋᴀʀᴀɴɢ ʜᴀɴʏᴀ ᴀᴅᴍɪɴ ʏᴀɴɢ ᴅᴀᴘᴀᴛ ᴍᴇɴɢɪʀɪᴍ ᴘᴇꜱᴀɴ.\n\nｎｏｔｅ: ꜰᴏʟʟᴏᴡ ɪɴꜱᴛʀᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/l4c1f2r'
  conn.sAnnounceOff = 'ɢʀᴏᴜᴘ ᴛᴇʟᴀʜ ᴅɪ ʙᴜᴋᴀ!\nꜱᴇᴋᴀʀᴀɴɢ ꜱᴇᴍᴜᴀ ᴘᴇꜱᴇʀᴛᴀ ᴅᴀᴘᴀᴛ ᴍᴇɴɢɪʀɪᴍ ᴘᴇꜱᴀɴ.\n\nｎｏｔｅ: ꜰᴏʟʟᴏᴡ ɪɴꜱᴛʀᴀɢʀᴀᴍ ᴏᴡɴᴇʀ: https://instagram.com/l4c1f2r'
  conn.sRestrictOn = 'ᴇᴅɪᴛ ɪɴꜰᴏ ɢʀᴜᴘ ᴅɪ ᴜʙᴀʜ ᴋᴇ ʜᴀɴʏᴀ ᴀᴅᴍɪɴ!'
  conn.sRestrictOff = 'ᴇᴅɪᴛ ɪɴꜰᴏ ɢʀᴜᴘ ᴅɪ ᴜʙᴀʜ ᴋᴇ ꜱᴇᴍᴜᴀ ᴘᴇꜱᴇʀᴛᴀ!'
