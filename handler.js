...
renderLargerThumbnail: true 
                ...
                try {
                    ...
                    if (m.limit)
                        m.reply(+m.limit + ' ʟɪᴍɪᴛ ᴛᴇʟᴀʜ ᴅɪ ᴘᴀᴋᴀɪ ✔️')
                }
                break
            }
        }
...
this.sendMessage(id, {
    ...
    contextInfo: {
        ...
        externalAdReply: {
            ...
            title: 'Ｇｒｏｕｐ Ｓｅｔｔｉｎｇ',
            thumbnailUrl: "https://telegra.ph/file/5708f9d4393db20cf0ba1.jpg",
            sourceUrl: '',
            mediaType: 1,
            renderLargerThumbnail: true
        }
...
const imek = fs.readFileSync(prn);
    ...
    if (msg) return conn.reply(m.chat, msg, fvn, {
                    contextInfo: {
                    mentionedJid: [m.sender],
                    externalAdReply: {
                        showAdAttribution: true,
                        title: `ＡＣＣＳＥＳ ＤＡＮＩＥＤ`,
                        thumbnailUrl: 'https://telegra.ph/file/edd64fa92bc68e7b10c6f.jpg',
                        sourceUrl: sig,
                        mediaType: 1,
                        renderLargerThumbnail: true
                    }
